...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="synth:synthEquipmentUsageRecord:edit"><li><a href="${ctx}/synth/synthEquipmentUsageRecord/form">设备使用记录添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="synthEquipmentUsageRecord">
			<tr>
				...
				<td>
					${synthEquipmentUsageRecord.register.code}
				</td>
				<td>
				...
				<td>
					<fmt:formatDate value="${synthEquipmentUsageRecord.operateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>

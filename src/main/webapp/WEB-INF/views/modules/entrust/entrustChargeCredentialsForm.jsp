...
<body>
	...
	<form:form id="inputForm" modelAttribute="entrustChargeCredentials" action="${ctx}/entrust/entrustChargeCredentials/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:input path="entrustId" value="entrustId"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="entrust:entrustChargeCredentials:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
